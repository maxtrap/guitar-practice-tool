...
const TempoDisplay = ({ inputValue, onChange, inputRef }) => {
    return <StyledTempoInput ref={inputRef} value={inputValue} onChange={onChange} width={inputValue.toString().length} />
}
